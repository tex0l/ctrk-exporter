...
import { CTRKParser, type TelemetryRecord } from '@ctrk/parser';
import {
  validateExtension,
  validateFileSize,
  validateMagicBytes,
...
import {
  ...
  detectLapCrossings,
  isValidGps,
} from '../src/lib/gps-utils';
import {
  computeLapTimes,
  computeSessionSummary,
  formatLapTime,
  formatDelta,
} from '../src/lib/lap-timing';
import { exportLapTimesToCsv } from '../src/lib/export-utils';
import { CHANNEL_GROUPS, getLapColor, getEnabledChannels } from '../src/lib/chart-config';

// Use committed test data from parser package
const TEST_DATA_DIR = join(__dirname, '..', '..', 'parser', 'test-data');
